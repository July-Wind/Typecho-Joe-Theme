        ...
        <section class="j-adaption">
            <section class="main <?php $this->options->JListType() ?>">
                ...
                <section class="j-index-article article">
                    <div class="banner"><div style="position: relative;padding-top: 20%;display: block;transition: opacity 0.35s;border-radius: calc(var(--radius-pc) / 2) calc(var(--radius-pc) / 2) 0 0;background-position: right;background-repeat: no-repeat;background-size: contain;background-color: #030a24;overflow: hidden;height: 100%;background-image: url('https://public.by.files.1drv.com/y4m8Wtj3AeI5m-g6BP9JLMpyXOsBIIYkiKL-tR37dFgV9PsB9GcPu7xrnI93kmJ419XTUKD2QoIQkMv6sxKfsLzbNx1tKid5lYQ6L4m39Mn51t8na6TeXDQ74CfCo1hvRTkEhaKm0Wp41EXwYuepVH3N8fNDdimvxLyoNnPd0UdARB-DtsQFRjOJe3FVYmXz2oswZO69xisf9bZF5x5QC6UlTSIVl7Wx3CIR8_UQ6Jt3yfRecbX-r1azu_XurBpHQoQ')"></div></div>
                ...
                $githubUser = $this->fields->github;
                if ($githubUser == "" || $githubUser == null){
                    echo '<script>document.querySelector(".github_tips").innerHTML("请填写正确的github用户名，主题检查github用户为空或者错误，已经切换htg-18114用户仓库项目。");</script>';
                    $githubUser = 'htg-18114';
                }
                ?>
