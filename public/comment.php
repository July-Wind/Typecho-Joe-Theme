            ...
            <div class="item">
                ...
                <div class="right">
                    <div class="name">
                        ...
                        <span style="border-radius: 3px;color: #ffffff;padding-right: 5px; padding-left: 5px;background: #4e7cf2;font-size: 12px;float: left;height: 16px;line-height: 16px;"><?php dengji($comments->mail);?></span>
