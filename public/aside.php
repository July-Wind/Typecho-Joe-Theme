<div class="j-aside">
    <?php if ($this->options->JAuthorStatus !== 'off') : ?>
        <div class="aside aside-user">
            ...
            <div class="webinfo">
                ...
                <div class="item" title="累计字符">
                    <span class="num"><?php echo allOfCharacters(); ?></span>
                    <span>全站字符</span>
                </div>
            </div>
    ...
    <?php if ($this->options->JAsideCustom) : ?>
        <div class="aside aside-custom" style="color: var(--info);text-align: center;">
